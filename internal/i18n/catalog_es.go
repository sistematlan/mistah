...
var spanish = map[string]string{
	...
	"system.imessage.detail.simple":   "%d adjuntos de iMessage de más de %d meses; los chats no se borran",
	"system.imessage.detail.advanced": "%d archivos en Messages/Attachments con mtime > %d meses (chat.db intacto)",
	...
	"wizard.menu.dev-detected":   "Detectamos herramientas de desarrollo — también incluimos tus cachés de dev.",
	"wizard.cancelled":           "Cancelado. No se borró nada.",
	"wizard.thanks":              "Listo. Gracias por usar mistah.",
	"wizard.level.light.name":    "Ligera",
	"wizard.level.light.desc":    "Cachés de apps, papelera, miniaturas — lo que toda Mac acumula",
	"wizard.level.standard.name": "Estándar",
	"wizard.level.standard.desc": "Ligera + Docker, Xcode, snapshots de Time Machine, logs",
	"wizard.level.deep.name":     "Profunda",
	"wizard.level.deep.desc":     "Estándar + huérfanos, Downloads, backups de iPhone (pregunta por ítem)",
	"wizard.confirm.level":       "Nivel",
	"wizard.confirm.items":       "ítems",
	"wizard.confirm.prompt":      "¿Continuar? [s/N] ",
	"wizard.review.header":       "Ahora revisemos uno por uno los archivos que pueden ser tuyos.",
	"wizard.review.subtitle":     "Pueden contener datos tuyos: confirma cada uno con s/N (v=ver contenido, q=salir).",
}
