...
// List enumerates .app bundles under /Applications and ~/Applications,
// sizing each with disk.DirSize and resolving last-used date via
...
// lastUsedDate asks Spotlight for kMDItemLastUsedDate, the same field
// Finder's "Date Last Opened" column reads. Apps Spotlight has never
// indexed (or that were never launched) report "(null)".
